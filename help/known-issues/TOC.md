...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + Problemi attuali in [!DNL Adobe Workfront] {#wf-current}
      ...
      + [Bilanciatore dei carichi di lavoro: l’utente viene visualizzato come sovrassegnato a causa di una capacità non accurata](known-issues-workfront/wf-workload-balancer-overallocation-due-to-inaccurate-capacity.md)
      ...
      + [Bozze: la bozza approvata rimane nell’[!UICONTROL Elenco lavori della Home ]nel ruolo approvatore](known-issues-workfront/wf-proofs-proofs-stuck-in-worklist-august.md)
      ...
      + [Bozze: le opzioni di approvazione non vengono visualizzate in [!UICONTROL Proofing Viewer]](known-issues-workfront/wf-proofs-approval-options-not-appearing-in-proof-viewer.md)
      + [Schede orario: errori durante la registrazione delle ore sulla scheda orario](known-issues-workfront/wf-timesheets-error-when-saving-hours.md)
...
+ [!DNL Workfront Proof] {#proof}
   ...
   + Problemi attuali in [!DNL Workfront Proof] {#proof-current}
      ...
      + [Impossibile aggiungere alla bozza una persona taggata in un commento](known-issues-workfront-proof/cannot-add-user-to-proof.md)
...
+ [!DNL Adobe Workfront Fusion] {#fusion}
   ...
   + Problemi attuali in [!DNL Workfront Fusion] {#fusion-current}
      ...
      + [[!DNL Workfront Fusion]: lo scenario produce l’errore “[!UICONTROL lettura ECONNRESET]”](/help/known-issues/known-issues-workfront-fusion/fusion-read-econnreset-error.md)
