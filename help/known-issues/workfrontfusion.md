...
| **Problema** | **Ultima Modifica** |
| -----------------------------------------------------------------| ----------------- |
| [[!DNL Workfront Fusion]: errore ](/help/known-issues/known-issues-workfront-fusion/fusion-cannot-execute-update.md) “[!UICONTROL impossibile eseguire l’aggiornamento]” | 8 giugno 2023 |
